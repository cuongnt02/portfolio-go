...
func (app *application) userLogin(w http.ResponseWriter, r *http.Request) {
    data := app.newTemplateData(r)
    data.FormActionPath = "/user/login"

    data.Form = userLoginForm{}
    app.render(w, http.StatusOK, "user-login.html", data)
}
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
    ...
    form.CheckField(validator.NotBlank(form.Email), "email", "Email should not be blank.")
    form.CheckField(validator.Matches(form.Email, validator.EmailRegExp), "email", "Email must be a valid email.")
    form.CheckField(validator.NotBlank(form.Password), "password", "Password should not be blank.")

    if !form.Valid() {
        data := app.newTemplateData(r)
        data.Form = form
        data.FormActionPath = "user/login"
        app.render(w, http.StatusUnprocessableEntity, "user-login.html", data)
        return
    }
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
    ...
    form.CheckField(validator.NotBlank(form.Username), "username", "Username should not be blank.")
    form.CheckField(validator.NotBlank(form.Email), "email", "Email should not be blank.")
    ...
    if !form.Valid() {
        ...
        data.Form = form
        data.FormActionPath = "/user/signup"
        app.render(w, http.StatusUnprocessableEntity, "user-signup.html", data)
        return
    }
    ...
    app.sessionManager.Put(r.Context(), "flash", "Your sigup was successful. Please log in.")
